...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    calculator: {
      titleStart: "Synthetic Arbitrage.",
      titleEnd: "Pure Mathematics Without On-Chain Risk.",
      subtitle: "Calculate real net returns with instant deduction of taker fees and Level 2 VWAP slippage. No sluggish bridges or block confirmation delays.",
  ...
  es: {
    ...
    calculator: {
      titleStart: "Arbitraje Sintético.",
      titleEnd: "Matemática Pura sin Riesgo On-Chain.",
      subtitle: "Calcula el beneficio real con deducción instantánea de comisiones de taker y deslizamiento por profundidad L2. Sin puentes lentos ni liquidaciones por demora de bloque.",
